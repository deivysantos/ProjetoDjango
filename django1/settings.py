...
SECRET_KEY = 'django-insecure-vk0%kpv_%ff+zkqt(yg8l!o&50(w!th+tkvku$4mds!nhd^h0c'

# SECURITY WARNING: don't run with debug turned on in production!
#DEBUG com o valor TRUE = está em modo desenvolvimento
...
MIDDLEWARE = [
    ...
    'whtenoise.middleware.WhiteNoiseMiddleware',
